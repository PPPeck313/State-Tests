...
import 'package:state_tests/states/context/provided/bloc/models/counter_bloc.dart';
import 'package:state_tests/states/context/provided/bloc/models/notes_bloc.dart';
import 'package:state_tests/states/counter_view_model.dart';
import 'package:state_tests/states/notes_view_model.dart';

class BlocPage extends StatelessProvidedContextScopePage {
  BlocPage({super.key});
