...
import 'package:state_tests/states/context/provided/bloc/models/counter_cubit.dart';
import 'package:state_tests/states/context/provided/bloc/models/notes_cubit.dart';
import 'package:state_tests/states/counter_view_model.dart';
import 'package:state_tests/states/notes_view_model.dart';

class CubitPage extends StatelessProvidedContextScopePage {
  CubitPage({super.key});
