...
mixin _$CounterStoreX on CounterStoreXBase, Store {
  late final _$countAtom =
      Atom(name: 'CounterStoreXBase.count', context: context);
  ...
  late final _$CounterStoreXBaseActionController =
      ActionController(name: 'CounterStoreXBase', context: context);
